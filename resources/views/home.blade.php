...
<div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="card p-5 shadow-lg" style="max-width: 500px; width: 100%; background: rgba(35,57,93,0.85); border-radius: 24px;">
        <img src="{{ asset('imagens/logo2.png') }}" alt="Logo ENKI" class="logo-home">
        <h1 class="display-4 mb-3 mt-2 text-center">Bem-vindo ao <span style="color:#19e6a7;">ENKI</span></h1>
